...
import com.example.wallpaperappson.fragment.SearchFragment
import com.example.wallpaperappson.fragment.SearchFragmentDirections
...
class SearchRecyclerAdapter : RecyclerView.Adapter<SearchRecyclerAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        view.setOnClickListener {
            val intent = SearchFragmentDirections.actionSearchFragment2ToDetailFragment(dataListe)
